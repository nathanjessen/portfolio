          ...
          <footer className="mt-8">
            <div className="md:flex md:items-center md:justify-center">
              ...
              <div className="text-center md:flex md:items-center">
                <div className="text-base leading-6 font-medium">{testimonial.person}</div>
                ...
                {testimonial.title && (
                  <>
                    ...
                    <div className="text-base leading-6 font-medium">{testimonial.title}</div>
                  </>
                )}
              </div>
            </div>
