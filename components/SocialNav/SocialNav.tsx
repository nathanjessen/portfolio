...
const socialIcons = {
  ...
  medium: (
    <svg className='h-5 w-5' aria-hidden='true' fill='currentColor' viewBox='0 0 26 26'>
  ...
  return (
    ...
    >
      {Object.entries(socialLinks).map(([platform, url]) => {
        ...
        return (
          <motion.li key={platform} whileHover={{ scale: 1.1 }}>
            <a
              href={url}
              target='_blank'
              rel='noreferrer'
              className='relative p-2 inline-flex items-center justify-center transition-colors duration-200
                         text-base-content/70 hover:text-primary group'
            ...
            >
              ...
              {/* Focus ring */}
              <span className='absolute inset-0 rounded-full ring-primary/50 ring-offset-2 ring-offset-base-100 focus-within:ring-2' />
            </a>
          </motion.li>
        );
      })}
